 ...
 */
function isValidAnnounceProviderEvent(event: unknown): event is EIP6963AnnounceProviderEvent {
    return (
 ...
 */
function isValidProviderDetail(providerDetail: unknown): providerDetail is EIP6963ProviderDetail {
    if (
