...
import { EXTERNAL_PROVIDER } from '../../shared/constants/stream';
...
export type InpageProviderOptions = {
    /**
...
export class InpageProvider extends AbstractStreamProvider {
    ...
    /**
     * Indicating that this provider is a Chilly provider.
     */
    public readonly isChilly: true;

    /**
     * Creates a new `InpageProvider`.
     *
     * @param connectionStream - A Node.js duplex stream.
     * @param options - An options bag.
     * @param options.jsonRpcStreamName - The name of the internal JSON-RPC stream.
     * Default: `chilly-provider`.
    ...
    constructor(
        ...
        {
            jsonRpcStreamName = EXTERNAL_PROVIDER,
            logger = console,
     ...
     *
     * @fires InpageProvider#networkChanged
