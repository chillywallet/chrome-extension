...
/**
 * @type TypedMessageParamsInternal
 *
 * Represents the parameters to pass to the eth_signTypedData method once the signature request is approved
...
// Convert to a `type` in a future major version.
// eslint-disable-next-line @typescript-eslint/consistent-type-definitions
export interface TypedMessageParamsInternal extends AbstractMessageParamsInternal {
...
> {
    ...
    /**
     * Removes the internalId and version properties from passed messageParams and returns a promise which
     * resolves the updated messageParams.
     *
     * @param messageParams - The messageParams to modify.
     * @returns Promise resolving to the messageParams with the internalId and version properties removed.
     */
    prepMessageForSigning(messageParams: TypedMessageParamsInternal): Promise<TypedMessageParams> {
        // Using delete operation will throw an error on frozen messageParams
        const { internalId: _internalId, version: _version, ...messageParamsWithoutId } = messageParams;
